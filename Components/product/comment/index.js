    ...
    return (
        <>
            <div className={`${style.positionsComment}`}>
                ...
                <button onClick={slidePerv}
                        className={`${style.commentProduct_buttonNext} d-flex align-items-center justify-content-center btn`}>

                    <FontAwesomeIcon icon={faAngleLeft} className='fa-1x'/>
                </button>
                <button onClick={slideNext}
                        className={`${style.commentProduct_buttonPrev} d-flex align-items-center justify-content-center btn`}>
